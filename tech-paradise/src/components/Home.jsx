...
// first table 1 get request
  ...
  return (
    <div className="home" > 
      <p> Welcome to tech-paradise, this site is used to explore and submit reviews of electronics that are currently on the market</p>
      <p> Press the button at the top to see our enitre selection and leave a review  </p>
      <p> You can also press the buttons at the bottom to check and specify whats avaliable </p>
